...
namespace Packt.CS7
{
    public static class Protector
    {
        ...
        includePrivateParameters)
        {
            ...
            {
                xml = new XElement("RSAKeyValue", new XElement("Modulus", Convert.ToBase64String(p.Modulus)), new XElement("Exponent", Convert.ToBase64String(p.Exponent)));
            }
            return xml?.ToString();
        }
        ...
        {
            Register("Alexey", "Pa$$w0rd", new[] { "Admins" });
            Register("Artem", "Pa$$w0rd", new[] { "Sales", "TeamLeads" });
            Register("Evgeniy", "Pa$$w0rd");
        }
